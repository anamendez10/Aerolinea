        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary text-dark shadow-none ml-md-4" href="login.php">Iniciar Sesión</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    <div class="header-content">
                        ...
                        <h4 class="header-subtitle">Pensamos en ti, por eso tenemos los mejores vuelos a tu disposición</h4>
                ...
                <br><br><br><br><br>
                    <form class="header-form" name="datosusuario" method="post" action="registrarse.php">
                        <div class="head">Registrate con <span class="text-primary">Nosotros.</span></div>
                        <div class="body">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Confirmar contraseña*" name="confirmar_contrasena" required>
                            </div>
                        </div>
                        <div class="footer">
                            <button class="btn btn-primary btn-block" type="submit" name="subir">Registrarme</button>
                        </div>
